        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-12 menz-col pb-0 pull-right mobile-more">
                    ...
                    <select style="width: auto;" onchange="return window.location.href='{{ route('search',request()->slug)}}?d='+this.value" name="orderBy" class="form-control">
                     ...
                     <select style="width: auto;" onchange="return window.location.href='{{ route('search',request()->slug)}}?b='+this.value" name="orderBy" class="form-control">
                        ...
                        <table class="table table-striped menz-table">
                            <thead class="position-relative">
                                ...
                                <th scope="col" class="menz-date-filter">
                                    Dateidatum                    
                                    <a class="d-none d-md-inline-block" onclick="return window.location.href='{{ route('search',request()->slug) }}?d=ASC'"  href="javascript:void(0)">
                                      <i class="fa fa-caret-up"></i></a>
                                    <a class="d-none d-md-inline-block" onclick="return window.location.href='{{ route('search',request()->slug)}}?d=DESC'" href="javascript:void(0)">
                                      <i class="fa fa-caret-down"></i></a>
                                </th>
                                <th scope="col">Belegart</th>
                                <th scope="col" class="menz-date-filter">
                                    Belegnummer                    
                                    <a class="d-none d-md-inline-block" onclick="return window.location.href='{{ route('search',request()->slug)}}?b=ASC'"  href="javascript:void(0)">
                                      <i class="fa fa-caret-up"></i></a>
                                    <a class="d-none d-md-inline-block" onclick="return window.location.href='{{ route('search',request()->slug)}}?b=DESC'" href="javascript:void(0)">
                                      <i class="fa fa-caret-down"></i></a>
                                </th>
